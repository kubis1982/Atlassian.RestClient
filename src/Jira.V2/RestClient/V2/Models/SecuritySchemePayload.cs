...
namespace Kubis1982.Atlassian.Jira.RestClient.V2.Models
{
    ...
    public partial class SecuritySchemePayload : IParsable
    {
        /// <summary>The description of the security scheme</summary>
...
#nullable restore
        ...
        public global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.ProjectCreateResourceIdentifier Pcri { get; set; }
#endif
        /// <summary>The security levels for the security scheme</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecurityLevelPayload>? SecurityLevels { get; set; }
#nullable restore
#else
        public List<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecurityLevelPayload> SecurityLevels { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecuritySchemePayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecuritySchemePayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecuritySchemePayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "securityLevels", n => { SecurityLevels = n.GetCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecurityLevelPayload>(global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecurityLevelPayload.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SecurityLevelPayload>("securityLevels", SecurityLevels);
        }
    }
}
