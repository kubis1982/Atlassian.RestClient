...
#nullable restore
        ...
        public global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean_validateQuery? ValidateQuery { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "validateQuery", n => { ValidateQuery = n.GetEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean_validateQuery>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.SearchRequestBean_validateQuery>("validateQuery", ValidateQuery);
        }
    }
}
