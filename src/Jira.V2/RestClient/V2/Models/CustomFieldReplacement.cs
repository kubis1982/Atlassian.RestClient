...
namespace Kubis1982.Atlassian.Jira.RestClient.V2.Models
{
    ...
    public partial class CustomFieldReplacement : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.CustomFieldReplacement"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.CustomFieldReplacement CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.CustomFieldReplacement();
        }
        /// <summary>
