...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.JsonNode? Result { get; set; }
#nullable restore
#else
        public global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.JsonNode Result { get; set; }
#endif
...
#nullable restore
        ...
        public global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode_status? Status { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "result", n => { Result = n.GetObjectValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.JsonNode>(global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.JsonNode.CreateFromDiscriminatorValue); } },
                { "self", n => { Self = n.GetStringValue(); } },
                { "started", n => { Started = n.GetLongValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.JsonNode>("result", Result);
            writer.WriteStringValue("self", Self);
            writer.WriteLongValue("started", Started);
            writer.WriteEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.V2.Models.TaskProgressBeanJsonNode_status>("status", Status);
