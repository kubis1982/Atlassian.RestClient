...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.Project>? Values { get; private set; }
#nullable restore
#else
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.Project> Values { get; private set; }
#endif
        ...
        public static global::Kubis1982.Atlassian.Jira.RestClient.Models.PageBeanProject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.Models.PageBeanProject();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "values", n => { Values = n.GetCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.Models.Project>(global::Kubis1982.Atlassian.Jira.RestClient.Models.Project.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
