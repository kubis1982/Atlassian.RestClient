...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemeEventPayload>? NotificationSchemeEvents { get; set; }
#nullable restore
#else
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemeEventPayload> NotificationSchemeEvents { get; set; }
#endif
        /// <summary>The strategy to use when there is a conflict with an existing entity</summary>
        public global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload_onConflict? OnConflict { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "notificationSchemeEvents", n => { NotificationSchemeEvents = n.GetCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemeEventPayload>(global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemeEventPayload.CreateFromDiscriminatorValue)?.AsList(); } },
                { "onConflict", n => { OnConflict = n.GetEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload_onConflict>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemeEventPayload>("notificationSchemeEvents", NotificationSchemeEvents);
            writer.WriteEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.Models.NotificationSchemePayload_onConflict>("onConflict", OnConflict);
