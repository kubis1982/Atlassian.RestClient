...
#nullable restore
        ...
        public global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload_onConflict? OnConflict { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "onConflict", n => { OnConflict = n.GetEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload_onConflict>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Kubis1982.Atlassian.Jira.RestClient.Models.IssueTypePayload_onConflict>("onConflict", OnConflict);
