...
#nullable enable
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutConfiguration>? Configuration { get; set; }
#nullable restore
#else
        public List<global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutConfiguration> Configuration { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutPayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutPayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutPayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "configuration", n => { Configuration = n.GetCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutConfiguration>(global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Kubis1982.Atlassian.Jira.RestClient.Models.FieldLayoutConfiguration>("configuration", Configuration);
