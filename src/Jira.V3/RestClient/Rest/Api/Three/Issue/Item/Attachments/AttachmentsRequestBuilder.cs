...
using System;
namespace Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Item.Attachments
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Item.Attachments.AttachmentsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::Kubis1982.Atlassian.Jira.RestClient.Models.Attachment&gt;</returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::Kubis1982.Atlassian.Jira.RestClient.Models.Attachment>?> PostAsync(List<global::Kubis1982.Atlassian.Jira.RestClient.Models.MultipartFile> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Kubis1982.Atlassian.Jira.RestClient.Models.Attachment>> PostAsync(List<global::Kubis1982.Atlassian.Jira.RestClient.Models.MultipartFile> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Kubis1982.Atlassian.Jira.RestClient.Models.Attachment>(requestInfo, global::Kubis1982.Atlassian.Jira.RestClient.Models.Attachment.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<global::Kubis1982.Atlassian.Jira.RestClient.Models.MultipartFile> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<global::Kubis1982.Atlassian.Jira.RestClient.Models.MultipartFile> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Item.Attachments.AttachmentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Item.Attachments.AttachmentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Item.Attachments.AttachmentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
