...
using System;
namespace Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Archive
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Archive.ArchiveRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<string?> PostAsync(global::Kubis1982.Atlassian.Jira.RestClient.Models.ArchiveIssueAsyncRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PostAsync(global::Kubis1982.Atlassian.Jira.RestClient.Models.ArchiveIssueAsyncRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Kubis1982.Atlassian.Jira.RestClient.Models.ArchiveIssueAsyncRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Kubis1982.Atlassian.Jira.RestClient.Models.ArchiveIssueAsyncRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Archive.ArchiveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Archive.ArchiveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Issue.Archive.ArchiveRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
