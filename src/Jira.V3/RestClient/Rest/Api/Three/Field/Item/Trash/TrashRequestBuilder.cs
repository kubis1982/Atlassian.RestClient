...
using System;
namespace Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Field.Item.Trash
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Field.Item.Trash.TrashRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Field.Item.Trash.TrashRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Field.Item.Trash.TrashRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Kubis1982.Atlassian.Jira.RestClient.Rest.Api.Three.Field.Item.Trash.TrashRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
