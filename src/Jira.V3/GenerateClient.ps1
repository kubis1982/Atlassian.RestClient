...
<#
.SYNOPSIS
    Generates Jira REST client using Microsoft Kiota from OpenAPI specification.

.DESCRIPTION
    This script automates the generation of a strongly-typed Jira REST client.
    It downloads the latest OpenAPI spec from Jira, validates it, and generates
...
# Configuration
$SwaggerUrl = "https://dac-static.atlassian.com/cloud/jira/platform/swagger-v3.v3.json?_v=1.8516.116"
$OutputDir = "RestClient"
$Namespace = "Kubis1982.Atlassian.Jira.RestClient"

Write-Host "================================================"   -ForegroundColor Cyan
Write-Host "  Jira REST client Generator (Kiota)"          -ForegroundColor Cyan
Write-Host "================================================"   -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "[3/3] Generating Jira Rest client..." -ForegroundColor Yellow
...
Write-Host "  3. Update JiraRestClient to use generated client" -ForegroundColor Gray
Write-Host ""
